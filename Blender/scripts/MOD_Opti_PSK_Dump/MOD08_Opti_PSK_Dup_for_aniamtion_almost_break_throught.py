#!BPY
""" 
Name: 'Unreal Skeletal Mesh/Animation (.psk and .psa)MOD08' 
Blender: 240 
Group: 'Export' 
...
-Animatoin here to fix mat error do not over ride it.
			...
			for i in range(frame_count):
				...
				for bone_data in ordered_bones:
					...
					if not blender_bone.hasParent():
						bones_main = [x for x in current_armature.bones.values() if not x.hasParent()]
						print "MAIN:",bones_main
						print "MAT:",bones_main.matrix['BONESPACE'].toQuat()
						#parent_mat = obj.mat
						print obj.name
					...
					vkey.Orientation = make_fquat_anim(quat)
