#!BPY
""" 
Name: 'Unreal Skeletal Mesh/Animation (.psk and .psa) Mod11' 
Blender: 245
Group: 'Export' 
Tooltip: 'Unreal Skeletal Mesh and Animation Export (*.psk, *.psa) Mod11' 
""" 
...
def parse_meshes(blender_meshes, psk_file):
	...
	for current_obj in blender_meshes: 
		...
		me = current_mesh
		#==========================================================================================
		# Start Mesh Working for triangle
		#==========================================================================================
		for v in me.verts:
		...
		for f in me.faces:
			...
			if numv==3:
				...
				nme.faces.append(nf)
		#==========================================================================================
		# END Mesh Working for triangle
		#==========================================================================================
		current_mesh.faces = nme.faces
