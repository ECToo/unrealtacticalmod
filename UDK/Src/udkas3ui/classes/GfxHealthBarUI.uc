...
class GfxHealthBarUI extends GFxMoviePlayer;
...
function HealthBarDisplay(bool _display){
	if(_display){
		StartPlayer();
    }else{
        ClosePlayer();     
...
defaultproperties
{
    ...
    //MovieInfo=SwfMovie'udkas3hui.UDKAS3HealthBarUI'
    MovieInfo=SwfMovie'udkas3hui.UDKHealthBarUI'
}