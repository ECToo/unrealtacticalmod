class TacticalModGame extends UTGame;

simulated function PostBeginPlay()
{
	super.PostBeginPlay();
	`log("[TacticalModGame] - Initialized and running");
}
...
defaultproperties
{
	...
	//TMod_GameMenuMod.MidGameMenu //<-this one!
	//MidGameMenuTemplate=DFMidGamePanel'MyMOD.TMod_GameMenuMod.MidGameMenu';
