...
class UTVehicle_HAC_Content extends UTVehicle_HAC;
...
defaultproperties
{
	...
	Begin Object Name=SVehicleMesh
		SkeletalMesh=SkeletalMesh'VH_Custom_Armor_Car.vehicle_heavy_armor'          //WORK
		PhysicsAsset=PhysicsAsset'VH_Custom_Armor_Car.vehicle_heavy_armor_Physics'
		AnimTreeTemplate=AnimTree'VH_Custom_Armor_Car.vehicle_heavy_armor_animtree'
		AnimSets(0)=AnimSet'VH_Custom_Armor_Car.vehicle_heavy_armor_NewAnimSet'
		MorphSets[0]=MorphTargetSet'VH_Custom_Armor_Car.vehicle_heavy_armor_NewMorphTargetSet'
