 ...
 */
class UTWeap_EnergyRifle extends UTWeapon;
...
defaultproperties
{
	...
	Begin Object Name=FirstPersonMesh
		SkeletalMesh=SkeletalMesh'WP_EnergyRifle.WP_EnergyRifle_1P'   //1 Person
		//AnimSets(0)=AnimSet'WP_ShockRifle.Anim.K_WP_ShockRifle_1P_Base'
		AnimSets(0)=AnimSet'WP_EnergyRifle.WP_EnergyRifle_NewAnimSet' //Need to work on the animation later.
	...
	AttachmentClass=class'mymod.UTAttachment_EnergyRifle'

	Begin Object Name=PickupMesh // When player die when drop weapon or picking up an weapon
		SkeletalMesh=SkeletalMesh'WP_EnergyRifle.WP_EnergyRifle_3P'
		//Scale=3.0  //weapon Draw scale
	End Object
