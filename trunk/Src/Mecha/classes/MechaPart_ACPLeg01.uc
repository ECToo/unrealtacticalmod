...
class MechaPart_ACPLeg01 extends MechaPart_Leg;
...
defaultproperties
{
     bodytype = "leg"
      Begin Object Name=MeshFrame
		SkeletalMesh=SkeletalMesh'VH_Mecha.mechplain_leg'
		PhysicsAsset=PhysicsAsset'VH_Mecha.mechplain_leg_Physics'
