	...
	if (bWeaponFire){
           fireinterval++;
              if (fireinterval > firerate){
			    ...
			    //SpawnedProjectile.Init(MechVehicle.Location);
			    SpawnedProjectile.Init(Vector(MechVehicle.Rotation));
			    //SpawnedProjectile.Init(weapondirection);


			    
			    //SpawnedProjectile.Init( Vector(GetAdjustedAim( RealStartLoc )) );
			    //GetAdjustedAim( RealStartLoc );
		           }
                        }
             }
	}
